...
def start_number(**context):
    context["ti"].xcom_push(key='current_value',value=10) #ti is task instance.
    #The object ti (task instance) is passed automatically in the **context when provide_context=True is set in the PythonOperator below.
